...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resources([
        ...
        'checklistone' => 'InventoryChecklistOneController',
        'checklisttwo' => 'InventoryChecklistTwoController',
        'tin' => 'TinController',
        'routines' => 'RoutineController',
        'apr' => 'AprController',
        'apr_in' => 'AprStockInController',
        'apr_out' => 'AprStockOutController',
        'books' => 'BooksController',
        'books/books_in' => 'BooksInController',
        'books/books_out' => 'BooksOutController',
        'ics' => 'IcsController',
        'burs' => 'BursController',
