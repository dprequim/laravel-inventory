@extends('layouts.app', ['page' => 'New Inventory Checklist', 'pageSlug' => 'checklisttwo-create', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('checklisttwo.index') }}" class="btn btn-sm btn-primary">Back to List</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('checklisttwo.store') }}" autocomplete="off">
                            @csrf
                            <div class="pl-lg-4">
