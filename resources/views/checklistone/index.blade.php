@extends('layouts.app', ['page' => 'checklistone', 'pageSlug' => 'checklistone', 'section' => 'checklistone'])
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <form action="{{ route('checklistone.index') }}" method="GET">
                                ...
                                <a href="{{ route('checklistone.index') }}" class="btn btn-sm btn-secondary">Refresh</a>
                            </form>
                        </div>
                        
                        <div class="col-4 text-right">
                            <a href="{{ route('checklistone.create') }}" class="btn btn-sm btn-primary">Add Checklist</a>
                            <a href="{{ 'api/checklistone/pdf' }}" class="btn btn-sm btn-primary">Print</a>
                                ...
                                @foreach ($checklistone as $item)
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <a href="{{ route('checklistone.edit', $item) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit Item">
                                                <i class="tim-icons icon-pencil"></i>
                                            </a>
                                            <form action="{{ route('checklistone.destroy', $item) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
